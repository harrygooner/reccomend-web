...
const SignIn = (props) => {
  ...
  const submitHandler = (e) => {
    ...
    fetch(
      "https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=AIzaSyAl2FEyO_EB00fcmBR7DqIC08aKGNAB6hc",
      {
        method: "POST",
        body: JSON.stringify({
  ...
  return (
    ...
    >
      ...
      >
        ...
        <span className="font-medium px-2">Sign in with google</span>
      </div>
    </form>
  );
};
